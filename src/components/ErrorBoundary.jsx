            ...
            return (
                <div className="min-h-screen flex items-center justify-center p-4">
                    <div className="bg-darkCard rounded-lg p-8 max-w-md text-center">
                        <h1 className="text-2xl font-bold mb-4 text-danger">Alguma coisa deu muito errado 😢</h1>
                        ...
                        <p className="text-gray-400 mb-6 text-sm">Por favor, tente recarregar a página ou verifique o console para mais detalhes.</p>
